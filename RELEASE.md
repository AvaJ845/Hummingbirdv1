...
- [ ] **Promotional Image** (optional, 1024×1024) for each product — **use `AppStore/promo/SubscriptionPromo-Plans.png`**. Shown in win-back / offer-code sheets, and on the product page if App Store Promotion is enabled. Regenerate with `python3 AppStore/promo/render_promo.py`; see `AppStore/promo/README.md`.
